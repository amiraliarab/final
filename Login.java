        ...
        if (txtname.getText().equals("Admin") && txtpass.getText().equals("Admin")) {
            ...
            try {
                ...
                PreparedStatement ps
                        = conn.prepareStatement("SELECT * FROM person WHERE name = ? AND pass = ?");
                ...
                if (rs.next()) {
                    ...
                    PrsonForm.main(rs.getString("namesh"), rs.getString("family"));
                    
                  } else {
                    
                      JOptionPane.showMessageDialog(null, "این شخص ثبت شده نیست", "", JOptionPane.INFORMATION_MESSAGE);
